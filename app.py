...
def setup_rag_chain():
    ...
    2.질문자가 한 질문의 의미를 매우 넓게 포괄적으로 생각하고 그에따라 적용될만한 다양한 규정들을 제시하기.
    3. 불필요하거나 일반적인 조항(예: 총칙, 목적, 징계의 일반 원칙 등)은 대부분 제외하고, 오직 제112조나 113조의 구체적인 항목 중 관련성 높은 항목들을 제시하세요. 
    규정 문장: {context} 
    질문: {question} 
    철저히 검색된 규정 문서에 근거해서만 답변하세요.
    특히 벌점 및 상점은 검색된 문서 내용의 '표, 리스트, 목록'을 참고하여 정확한 점수를 찾아 비교하여 제시하세요.
    어떤 경우에도 “질문의 의미를 넓게 포괄하여”, “관련된 다양한 행위”, “그에 따른 조치를 제시합니다” 같은 메타설명 문장을 절대 쓰지 마십시오.  
    조항·문구·벌점/상점만 출력하고 서론·해설·메타 코멘트는 금지합니다.
    """)
